...
$(() => {
    ...
    // ############################################################
    // Create and prepend the button
    const outline = $('<button class="btn btn-light border round" data-bs-toggle="tooltip" title="My Location"></button>');
    ...
    const getCentreData = () => {
        ...
        getCurrentAddress(lat, lng, data => {
            ...
            if (currentCountry.toLowerCase() !== data.results[0].country_code) {
